...
namespace Enma
{
	...
	{
		//Max amounts in a batch per drawcall
		const uint32_t MaxQuads = 10000;
		const uint32_t MaxVertices = MaxQuads*4;
		const uint32_t MaxIndices = MaxQuads * 6;
		static const uint32_t MaxTextureSlots = 32; //TODO: Detect render capabilities
		...
		uint32_t TextureSlotIndex = 1; //Texture slot 0 is reserved for the white default texture
	};
